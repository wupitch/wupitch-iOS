...
let onboardingData: [Onboarding] = [
    Onboarding(titleLabelName: "내가 원하는 팀 스포츠\n크루를 한 눈에!", descriptionLabelName: "혼자할 수 없는 다양한 크루 스포츠에 가입해보세요.", onboardingImageName: "imgOnbd01"),
    Onboarding(titleLabelName: "자유롭게 만나는\n스포츠 메이트!", descriptionLabelName: "번개를 통해 종목에 상관없이 메이트를 찾아보세요.", onboardingImageName: "imgOnbd02"),
