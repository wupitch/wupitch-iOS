//
//  SignUpEnrollmentService.swift
//  wupitch
//
//  Created by 김수정 on 2021/12/13.
//
//SignUpEnrollmentService
import Foundation
import Alamofire

struct SignUpEnrollmentService {
    static let shared = SignUpEnrollmentService()

    func getSignUpEnrollment(delegate: BungaeDetailVC) {
