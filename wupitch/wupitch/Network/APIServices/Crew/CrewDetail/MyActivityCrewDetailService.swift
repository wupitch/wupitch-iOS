//
//  MyActivityCrewDetailService.swift
//  wupitch
//
//  Created by 김수정 on 2021/12/16.
//

// 내활동 크루 디테일 소개에 들어가는 api
import Foundation
import Alamofire

struct MyActivityCrewDetailService {
    static let shared = MyActivityCrewDetailService()

    func getMyActivityCrewDetail(delegate: MyActivityDetailIntroductionVC) {
        ...
        AF.request(urlString,
                   ...
                   headers: header).responseDecodable(of: GenericResponse<CrewDetailResult>.self
                       ...
                       case .success(let response):
                           ...
                           print("크루 디테일 나오니?")
                           delegate.didSuccessMyActivityCrewDetail(result: data)
